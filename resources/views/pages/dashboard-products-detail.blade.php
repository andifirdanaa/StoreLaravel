                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group mt-3">
                                <label for="nameToko">Product Name </label>
                                ...
                                @foreach($product->galleries as $gallery)
                                    <div class="col-md-4">
                                        <div class="gallery-container">
                                            <img src="{{Storage::url($gallery->photos ?? '')}}" alt="" class="w-100 image-details" style="height:250px">
                                            <a href="{{route('dashboard-product-gallery-delete', $gallery->id)}}" class="delete-gallery">
                                              <img src="/images/products/icon-remove.svg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                @endforeach
